	...
	public void DesenhaSe(Graphics2D dbg, int XMundo, int YMundo) {
		// TODO Auto-generated method stub
			...
			if (tipo==1) {
				...
				dbg.drawString("+"+xp+" XP ", (int)X-3, (int)Y-3);
			...
			if (tipo==2) {
				...
				dbg.drawString("+Level UP "+CanvasGame.minhaNave.nivel, (int)X, (int)Y);
							
				dbg.setColor(Color.yellow);
		
				dbg.drawString("+Level UP "+CanvasGame.minhaNave.nivel, (int)X-5, (int)Y-5);
			    dbg.setComposite(AlphaComposite.getInstance(AlphaComposite.SRC_OVER, 1));
		    ...
		    System.out.println(alpha);
				...
				dbg.setFont(new Font("SansSerif", Font.BOLD, 14));
